    ...
    <div class="menu" id="login_form">
        ...
        <form action="update_post.php" method="post">
            ...
            <div class="form-group col-md-4">
                ...
                <input type="text" class="form-control" id="post_title" value="<?php echo $_GET['post_title']; ?>">
            </div>
            <div class="form-group col-md-4">
                <label for="post_text">Название</label>
                <textarea rows="10" cols="45" name="post_text" value="<?php echo $_GET['post_text']; ?>"></textarea>
            </div>
            <div class="form-group col-md-4">
                <label for="post_short_desc">Короткое описание</label>
                <input type="text" class="form-control" id="post_short_desc" value="<?php echo $_GET['post_short_desc']; ?>">
            </div>
            <div class="form-group col-md-4">
                <label for="post_start_date">Дата начала показа объявления</label>
                <input type="text" class="form-control" id="post_start_date" placeholder="yyyy-mm-dd" value="<?php echo $_GET['post_start_date']; ?>">
            </div>
            <div class="form-group col-md-4">
                <label for="post_end_date">Дата окончания показа объявления</label>
                <input type="text" class="form-control" id="post_end_date" placeholder="yyyy-mm-dd" value="<?php echo $_GET['post_end_date']; ?>">
            </div>
            </div>
